          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                />
                <p>my origin story began on{{selectedHero.originDate | shortDate}}</p>
              </div>
              <div class="field">
...
const ourHeroes = [
  {
    ...
    lastName: 'Papa',
    capeCounter:1,
    originDate:format(new Date(1994,3,1),inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter:3,
    originDate:format(new Date(1993,3,1),inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter:2,
    originDate:format(new Date(1996,3,1),inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter:0,
    originDate:format(new Date(1999,3,1),inputDateFormat),
